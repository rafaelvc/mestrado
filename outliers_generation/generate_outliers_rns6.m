function [outliers_ini,outliers,outliers_filtered,clock_ini,clock_end] = generate_outliers_rns6(data, dradius, dage, decayrate, eta, knears, ndetectors, runs, path_runs)
