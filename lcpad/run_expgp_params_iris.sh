...
DIR=iris_andras-dist3.0-curv0.5-f3_

ssh h01 "./e/launch_jobs_1-8.sh $DIR $GPPARAM $DSDIR > /dev/null 2>&1 </dev/null &"   
echo "h01 done" 
ssh h02 "./e/launch_jobs_9-15.sh $DIR $GPPARAM $DSDIR > /dev/null 2>&1 </dev/null &"  
echo "h02 done" 
