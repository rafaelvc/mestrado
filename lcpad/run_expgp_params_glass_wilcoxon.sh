...
# DSDIR=pop1000tree24muts15cx85gen100
# 
...
DIR=glass_andras-dist3.0-curv0.5-wilcoxon_

ssh h03 "./e/launch_jobs_1-8.sh $DIR $GPPARAM $DSDIR > /dev/null 2>&1 </dev/null &"   
echo "h03 done" 
ssh o01 "./e/launch_jobs_9-15.sh $DIR $GPPARAM $DSDIR > /dev/null 2>&1 </dev/null &"  
echo "o01 done" 
